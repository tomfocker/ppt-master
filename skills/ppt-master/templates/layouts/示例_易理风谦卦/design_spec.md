# 易理风谦卦示例模板 - Design Specification

> 从地山谦卦研究案例抽象出的东方哲思与传统文化研究模板。

## I. Template Overview

- Template ID: `示例_易理风谦卦`
- Source example: `ppt169_易理风_地山谦卦深度研究`
- Category: Special
- Applicable scenarios: 传统文化研究、国学课程、哲学主题汇报、文化讲座
- Design tone: 古朴、沉静、象数结构感，强调层层递进的学术叙述
