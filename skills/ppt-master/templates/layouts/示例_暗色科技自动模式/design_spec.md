# 暗色科技自动模式示例模板 - Design Specification

> 从 Claude Code Auto Mode 案例抽象出的暗色 AI 安全/工程深潜模板。

## I. Template Overview

- Template ID: `示例_暗色科技自动模式`
- Source example: `ppt169_general_dark_tech_claude_code_auto_mode`
- Category: General
- Applicable scenarios: AI 安全、工程架构、技术复盘、研发分享
- Design tone: 深色、克制、工程化，带有安全评审和系统架构气质
