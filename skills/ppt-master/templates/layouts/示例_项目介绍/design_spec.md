# 项目介绍示例模板 - Design Specification

> 从 PPT Master 项目介绍案例抽象出的通用产品/项目介绍模板。

## I. Template Overview

- Template ID: `示例_项目介绍`
- Source example: `demo_project_intro_ppt169_20251211`
- Category: General
- Applicable scenarios: 产品介绍、项目路演、工具说明、内部宣讲
- Design tone: 清晰、现代、结构化，强调功能模块与价值递进
