# 麦肯锡客户忠诚示例模板 - Design Specification

> 从客户忠诚度分析案例抽象出的经典麦肯锡式咨询模板。

## I. Template Overview

- Template ID: `示例_麦肯锡客户忠诚`
- Source example: `ppt169_麦肯锡风_kimsoong_customer_loyalty`
- Category: Brand
- Applicable scenarios: 客户研究、忠诚度分析、经营诊断、商业策略汇报
- Design tone: 经典咨询、MECE、极简数据驱动，强调结论与图表
